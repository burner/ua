...
alias MYSQL_TIME = st_mysql_time;
alias MYSQL_DATE = st_mysql_time;
alias MYSQL_DATETIME = st_mysql_time ;
alias MYSQL_TIMESTAMP = st_mysql_time;
alias MYSQL_TIMEDIFF = st_mysql_time ;
...
alias list_walk_action = int function(void*, void*);
...
// my_alloc.h stuff
struct st_used_mem {					 		/* struct for once_alloc (block) */
...
MYSQL* mysql_real_connect(MYSQL* mysql, const char* host,
	 ...
	 uint port, const char* unix_socket, uint clientflag);
...
void mysql_set_local_infile_handler(MYSQL* mysql, 
	...
	int function(void*, char*, uint) local_infile_read,
	void function(void*) local_infile_end,
	int function(void*, char*, uint) local_infile_error, void *);
...
my_bool mysql_stmt_send_long_data(MYSQL_STMT* stmt,
	uint param_number, const char* data, uint length);
